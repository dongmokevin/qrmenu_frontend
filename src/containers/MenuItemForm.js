...
const MenuItemForm = ({ place, onDone, item = {} }) => {
  ...
  const onAddCategory = async () => {
    ...
    if (json) {
      toast(`Category ${json.data.name} was created.`, { type: "success" });
      setCategory(json.data.id);
      setCategoryName("");
  ...
  const onAddMenuItems = async () => {
    ...
    if (json) {
      toast(`Menu Item ${json.data.name} was created`, { type: "success" });
      setCategory("");
      setPrice("");
      setName("");
      setDescription("");
  ...
  const onUpdateMenuItem = async () => {
    ...
    if (json) {
      toast(`Menu Item ${json.data.name} was updated`, { type: "success" });
      setCategory("");
      setName("");
      setPrice("");
      setDescription("");
